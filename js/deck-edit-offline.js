 /**
 *
 * Offline version of deck-edit.js
 * Powers deckEditorOffline.html with the power of a thousand suns...
 * and my insanity.
 *
 * Leave the comment in place to ensure you're still editing the offline file,
 * the live version will not include them. Please? Ok.
 *
**/

$(function() {
    // if we're here, we already have cards, lflist and setcodes, so we don't need to wait for the server to load them
    // also, this gets us past CORS. I mean, we're working locally, after all.
    for (list in lflist) {
...
var imgDir = "file:///C:/Users/IrateGod/AppData/Roaming/YGOPro%20Salvation/ygopro/pics/", 
